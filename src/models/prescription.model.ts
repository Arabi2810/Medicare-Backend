...
const TestSchema = new Schema<ITest>(
  {
    ...
    testDefinition: { type: String, default: null },
    patientRelevance: { type: String, default: null },
    validityLevel: { type: String, enum: ["essential", "moderate", "unnecessary", null], default: null },
  },
  { _id: true }
);
